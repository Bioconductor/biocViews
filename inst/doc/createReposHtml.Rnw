...
\begin{description}
  ...
  \item[bin/windows64/contrib/x.y] Contains all win64.binary packages
    (*.zip).  Where x.y is the major.minor version number of R.
  \item[bin/macosx/leopard/contrib/x.y] Contains the
    mac.binary.leopard (Leopard) (*.tgz) packages.
\end{description}
...
contribPaths <- c(source="src/contrib",
                  ...
                  mac.binary.leopard="bin/macosx/leopard/contrib/2.6")
@ 
