...
"affyPLM", "affyQCReport", "affylmGUI", "arrayMagic", "biocViews", 
"biomaRt", "bridge", "clusterStab", "edd", "fdrame", "genArise", 
...
"reb", "sagenhaft", "siggenes", "timecourse", "tkWidgets", "twilight", 
"vsn", "widgetInvoke", "widgetTools", "xcms")
@
