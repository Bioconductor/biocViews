...
"MCRestimate", "RBGL", "Rdbi", "Resourcerer", "Rgraphviz", "SAGElyzer", 
"affxparser", "affy", "affyPLM", "affylmGUI", "arrayMagic", "biocViews", 
"biomaRt", "clusterStab", "genArise", "geneplotter", "gtkWidgets", 
"hexbin", "ideogram", "limmaGUI", "maDB", "macat", "matchprobes", 
"nnNorm", "pdmclass", "pgUtils", "prada", "reb", "sagenhaft", 
"siggenes", "timecourse", "tkWidgets", "twilight", "vsn", "widgetInvoke", 
"widgetTools", "xcms")
@
...
that knows about the repository location.
<<doit>>=
jnk <- sapply( cc, ctv2html, packageURL=purl, reposname="Bioconductor")
@
